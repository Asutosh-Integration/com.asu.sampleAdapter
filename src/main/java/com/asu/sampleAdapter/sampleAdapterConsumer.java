 ...
 */
public class sampleAdapterConsumer extends ScheduledPollConsumer {
    private Logger LOG = LoggerFactory.getLogger(sampleAdapterConsumer.class);

    private final sampleAdapterEndpoint endpoint;


    public sampleAdapterConsumer(final sampleAdapterEndpoint endpoint, final Processor processor) {
